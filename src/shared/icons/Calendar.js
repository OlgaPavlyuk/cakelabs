...
const Calendar = (props) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 31.622 31.621" width={width} height={height}>
        ...
        <path d="M8.031 15.051h3.541v3.669H8.031z" />
        <path d="M14.102 15.051h3.541v3.669h-3.541z" />
        <path d="M20.172 15.051h3.542v3.669h-3.542z" />
        <path d="M8.031 21.502h3.541v3.668H8.031z" />
        <path d="M14.102 21.502h3.541v3.668h-3.541z" />
        <path d="M20.172 21.502h3.542v3.668h-3.542z" />
      </svg>
  );
};
